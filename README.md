...
An end-to-end, production-ready **Executive Business Intelligence (BI) Platform & AI Strategy Advisor** powered by **Monday.com GraphQL v2 API**, **FastAPI**, **Pandas**, **Recharts**, and **OpenAI GPT-4o mini**.
...
- **AI Strategy Advisor**: Natural language Q&A and Executive Leadership Report generation powered by OpenAI `gpt-4o-mini`, grounded strictly in pre-computed metrics.
...
graph TD
    ...
    E -->|Context Prompt| F[BI Agent / OpenAI GPT-4o mini]
...
| **AI Integration** | OpenAI Python SDK (v1.x) | GPT-4o mini for strategic advice and report generation |
...
│   │   └── bi_agent.py            # OpenAI LLM integration & report generation
│   ├── tests/
...
4. Add Environment Variables on Render dashboard (`OPENAI_API_KEY`, `MONDAY_API_KEY`, `DEALS_BOARD_ID`, `WORK_ORDERS_BOARD_ID`).
